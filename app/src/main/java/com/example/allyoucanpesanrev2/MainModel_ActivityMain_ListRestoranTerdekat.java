...
public class MainModel_ActivityMain_ListRestoranTerdekat implements Parcelable {
    private String Gambar_Restoran, Nama_Restoran, Jarak_Restoran, Meja_Tersedia;

    public MainModel_ActivityMain_ListRestoranTerdekat(String Nama_Restoran, String Gambar_Restoran, String Jarak_Restoran, String Meja_Tersedia) {
